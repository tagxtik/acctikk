...
class EditAllAccount extends StatefulWidget {
  final String org_id;
  ...
  @override
  State<EditAllAccount> createState() => _EditAllAccountState();
}

class _EditAllAccountState extends State<EditAllAccount> {
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    onPressed: () {
                                      final madeenval = validateDouble(
                                          textControllers[index]!.text);
                                      if (madeenval != null) {
                                        final newItem = selectedRadioIndexes ==
                                                0
                                            ? JornalModelDetails(
                                                entredBy: getUser(),
                                                type: accounttype,
                                        ...
                                        Provider.of<Jdetailmod>(context,
                                                listen: false)
